...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.invertimostuyyo.grossequityapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside(
            "com.invertimostuyyo.grossequityapp.security.DomainUserDetailsService",
